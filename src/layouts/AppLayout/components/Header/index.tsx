...
class Header extends React.Component<IHeaderProps> {
  public goToSettings = () => {
    this.props.history.push("/teacher/settings/general");
  };
      ...
      <Layout.Header className="main-layout-layout-header">
        ...
        <div className="main-layout-layout-header-right">
          <Menu mode="horizontal" selectedKeys={["-1"]}>
            ...
            >
              <Menu.Item key="setting:1" onClick={this.goToProfile}>
                <Icon type="user" />
                Profile
              </Menu.Item>
              <Menu.Item onClick={this.goToSettings} key="setting:2">
                <Icon type="setting" />
                Settings
              </Menu.Item>
              <Menu.Divider />
